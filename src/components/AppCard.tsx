...
const AppCard: React.FC<AppCardProps> = ({ app }) => {
  ...
  return (
    <div className="bg-white rounded-xl shadow-sm border border-slate-100 p-6 flex flex-col hover:shadow-xl transition-all hover:-translate-y-1">
      <div className="flex justify-between items-start mb-4">
        <div
          className={`h-14 w-14 rounded-xl ${categoryStyle.bgColor} flex items-center justify-center ${categoryStyle.iconColor}`}
        >
        ...
        {app.ssoEndpoint && (
          <span className="bg-osi-secondary/10 text-osi-secondary text-[10px] font-bold uppercase tracking-wider px-2 py-1 rounded-full flex items-center gap-1">
